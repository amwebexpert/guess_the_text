...
import 'package:guess_the_text/services/text.service/api.about.model.dart' as _i3;
import 'package:guess_the_text/services/text.service/api.category.model.dart' as _i6;
import 'package:guess_the_text/services/text.service/api.text.model.dart' as _i10;
import 'package:guess_the_text/services/text.service/api.texts.service.dart' as _i4;
import 'package:guess_the_text/features/game/game.played.items.storage.service.dart' as _i5;
import 'package:guess_the_text/features/game/game.store.dart' as _i11;
import 'package:guess_the_text/features/game/text_to_guess/text.to.guess.model.dart' as _i7;
...
class _FakeGamePlayedItemsStorageService_3 extends _i1.Fake implements _i5.GamePlayedItemsStorageService {}
...
class MockTextsService extends _i1.Mock implements _i4.TextsService {
  ...
  @override
  _i9.Future<_i3.ApiAbout> getAboutInfo() => (super.noSuchMethod(Invocation.method(#getAboutInfo, []),
      returnValue: Future<_i3.ApiAbout>.value(_FakeApiAbout_1())) as _i9.Future<_i3.ApiAbout>);
  @override
  _i9.Future<List<_i6.ApiCategory>> getCategories() => (super.noSuchMethod(Invocation.method(#getCategories, []),
      returnValue: Future<List<_i6.ApiCategory>>.value(<_i6.ApiCategory>[])) as _i9.Future<List<_i6.ApiCategory>>);
  @override
  _i9.Future<List<_i10.ApiText>> getTexts(String? categoryUuid) =>
      (super.noSuchMethod(Invocation.method(#getTexts, [categoryUuid]),
          returnValue: Future<List<_i10.ApiText>>.value(<_i10.ApiText>[])) as _i9.Future<List<_i10.ApiText>>);
}
...
class MockGameStore extends _i1.Mock implements _i11.GameStore {
  ...
  _i5.GamePlayedItemsStorageService get gamePlayedItemsStorageService =>
      (super.noSuchMethod(Invocation.getter(#gamePlayedItemsStorageService),
          returnValue: _FakeGamePlayedItemsStorageService_3()) as _i5.GamePlayedItemsStorageService);
  @override
  _i6.ApiCategory get currentCategory =>
      (super.noSuchMethod(Invocation.getter(#currentCategory), returnValue: _FakeApiCategory_4()) as _i6.ApiCategory);
  @override
  ...
  _i7.TextToGuess get textToGuess =>
      (super.noSuchMethod(Invocation.getter(#textToGuess), returnValue: _FakeTextToGuess_5()) as _i7.TextToGuess);
  @override
  ...
  _i8.ReactiveContext get context =>
      (super.noSuchMethod(Invocation.getter(#context), returnValue: _FakeReactiveContext_6()) as _i8.ReactiveContext);
  @override
  _i9.Future<void> selectCategory(_i6.ApiCategory? selected) =>
      (super.noSuchMethod(Invocation.method(#selectCategory, [selected]),
          returnValue: Future<void>.value(), returnValueForMissingStub: Future<void>.value()) as _i9.Future<void>);
  @override
  _i9.Future<void> shuffle() => (super.noSuchMethod(Invocation.method(#shuffle, []),
      returnValue: Future<void>.value(), returnValueForMissingStub: Future<void>.value()) as _i9.Future<void>);
  @override
  _i9.Future<void> tryLetter(String? c) => (super.noSuchMethod(Invocation.method(#tryLetter, [c]),
      returnValue: Future<void>.value(), returnValueForMissingStub: Future<void>.value()) as _i9.Future<void>);
  @override
...
class MockNavigatorObserver extends _i1.Mock implements _i12.NavigatorObserver {
  @override
  void didPush(_i12.Route<dynamic>? route, _i12.Route<dynamic>? previousRoute) =>
  ...
  @override
  void didRemove(_i12.Route<dynamic>? route, _i12.Route<dynamic>? previousRoute) =>
      super.noSuchMethod(Invocation.method(#didRemove, [route, previousRoute]), returnValueForMissingStub: null);
  @override
  void didReplace({_i12.Route<dynamic>? newRoute, _i12.Route<dynamic>? oldRoute}) =>
      super.noSuchMethod(Invocation.method(#didReplace, [], {#newRoute: newRoute, #oldRoute: oldRoute}),
          returnValueForMissingStub: null);
  @override
  void didStartUserGesture(_i12.Route<dynamic>? route, _i12.Route<dynamic>? previousRoute) => super
